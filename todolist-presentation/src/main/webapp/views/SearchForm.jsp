...
<body>
    ...
    <div class="row">
	  <form class="col s6 offset-s3">
	    <label>Date de début : </label><input type="date" class="datepicker">
	    <label>Date de fin : </label><input type="date" class="datepicker">
	    <button class="waves-effect waves-light btn"><i class="material-icons left">search</i>Rechercher</button>
	  </form>
    </div>
